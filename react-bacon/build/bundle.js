...
var Bacon, Label, React, TextField, labelStream, reverse, reverseText, textStream;
...
Label = React.createClass({
  ...
  render: function() {
    return React.DOM.p(null, this.state.text);
  }
});
...
React.renderComponent(React.DOM.div(null, TextField({
  stream: textStream
}), Label({
  stream: labelStream
})), document.body);
...
},{"baconjs":2,"react":149}],2:[function(require,module,exports){
(function (global){
(function() {
